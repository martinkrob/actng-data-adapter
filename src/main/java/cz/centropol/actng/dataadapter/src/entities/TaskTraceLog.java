 ...
 * @author krob
 */
@Entity(name = "SRCTaskTraceLog")
@Table(name = "t_task_trace_log", indexes = {@Index(columnList = "attempt_id")})
...
{    
    ...
    private SRCTaskEventType eventType;
     ...
     */
    public SRCTaskEventType getEventType()
    {
        return eventType;
    }
     ...
     */
    public void setEventType(SRCTaskEventType eventType)
    {
    ...
    @Column(name = "orig_reason_desc", nullable = true, length = 32)    
    ...
    @Column(name = "data1", nullable = true, length = 255)    
    ...
    @Column(name = "data2", nullable = true, length = 255)    
    ...
    @Column(name = "data3", nullable = true, length = 255)
